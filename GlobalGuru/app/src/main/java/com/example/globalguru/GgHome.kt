...
class GgHome : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val europeImage = arrayOf(
            R.drawable.europe1, R.drawable.europe2, R.drawable.europe3, R.drawable.europe4,
            R.drawable.europe5, R.drawable.europe6, R.drawable.europe7, R.drawable.europe8,
